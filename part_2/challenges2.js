...
Each team competes 3 times, and then the average of the 3 scores is calculated (so one average score
     per team).
A team ONLY wins if it has at least DOUBLE the average score of the other team. Otherwise, no team 
wins!
...
HINT: To check if number A is at least double number B, check for A >= 2 * B. Apply this to the
 team's average scores 😉
GOOD LUCK 😀
*/

// const calcAverage = (a, b, c )  => (a + b + c)/3;
// console.log(calcAverage(4,3,2));
...
on the rules above (you can check out the code from first tip calculator challenge if you need to). Use the function type
...
// console.log(`${mark.fullName} weights ${mark.mass}kg and is ${mark.height} m tall. ${john.fullName} weights ${mark.mass}kg and is ${mark.height}m`);
